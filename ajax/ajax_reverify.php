...
/**
 * \file    facturesituationmigration/ajax/ajax_reverify.php
 * \ingroup facturesituationmigration
 * \brief   AJAX endpoint to re-verify migrated cycles in batches.
 */
...
echo json_encode($migration->reverifyBatch($batch_size, $last_cycle_ref));
